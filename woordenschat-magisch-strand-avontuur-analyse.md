...
- **Gevolg op Galaxy:** Als een kind een sticker naar de onderrand van het strand sleept en zijn vinger per ongeluk 1 pixel over de rand van de objectenbalk beweegt, wordt de drop geannuleerd met de foutmelding: _"Laat het plaatje los op de scene"_.
...
- **Sterk punt:** De modus nodigt ouders/begeleiders uit om de taalproductie te beoordelen via het _Parent Observation Panel_.
...
- **Probleem:** Begrippen als _"tussen"_ of _"naast"_ zijn voor kinderen met een taalontwikkelingsstoornis (TOS) erg abstract.
