...
## [x] 📱 1. Schaalbaarheid & Aspect Ratio (Samsung Galaxy)
- [x] **Aspect Ratio Lock op de Scene**
...
## [x] 👆 2. Drag & Drop Interacties (Mobiel & Touch)
- [x] **Touch-Action Conflict Oplossen**
...
## [x] 🎓 3. Educatieve & Visuele Scaffolding
- [x] **Pulsing Target Zones (Doelzones)**
...
- [x] **Speelse Ondertiteling & Pictogrammen**
  * Bestanden: [SceneBuilderScreen.tsx](file:///Users/melkonian/git/Game-Wereld/src/app/games/woordenschat-bezem-escape/screens/SceneBuilderScreen.tsx)
