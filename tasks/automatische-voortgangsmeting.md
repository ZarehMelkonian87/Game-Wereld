...
- [x] **Fallbacks toevoegen**
  - Bestand: [progressData.ts](file:///Users/melkonian/git/Game-Wereld/src/app/screens/progress/progressData.ts)
  - Actie: Zorg voor een nette nulmeting (bijvoorbeeld 0% of een call-to-action zoals _"Speel Bezem Escape om je eerste voortgang te zien!"_) als er nog geen gameplay-data is voor de speler.
