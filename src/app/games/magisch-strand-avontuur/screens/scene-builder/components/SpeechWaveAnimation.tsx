...
export const SpeechWaveAnimation = ({ onStop, transcript }: SpeechWaveAnimationProps) => {
  ...
  return (
    <>
      ...
      `}</style>
      <div
        className="pointer-events-auto absolute bottom-4 left-1/2 z-30 flex max-w-[92vw] -translate-x-1/2 items-center gap-3 rounded-3xl border-2 border-white/60 bg-gradient-to-r from-sky-600/95 via-sky-500/95 to-indigo-600/95 px-4 py-2.5 shadow-2xl backdrop-blur-md transition-all duration-200"
