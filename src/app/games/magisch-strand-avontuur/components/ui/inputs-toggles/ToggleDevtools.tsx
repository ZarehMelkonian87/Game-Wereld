 ...
 * @description Witte kaart met sleutel-icoon en toggle switch voor ontwikkeltools.
 */
...
export const ToggleDevtools: React.FC<ToggleDevtoolsProps> = ({
  ...
  onChange,
  className = "",
  "data-testid": testId = "settings-zone-editor-toggle",
}) => {
  return (
    <button
      type="button"
      aria-label="Zone Editor DevTools aan of uit"
