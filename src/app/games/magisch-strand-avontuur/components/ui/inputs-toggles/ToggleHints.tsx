 ...
 * @description Witte kaart met gloeilamp-icoon en toggle switch voor mascotthints.
 */
...
export const ToggleHints: React.FC<ToggleHintsProps> = ({
  ...
  onChange,
  className = "",
  "data-testid": testId = "settings-hints-toggle",
}) => {
  return (
    <button
      type="button"
      aria-label="Hints aan of uit"
    ...
    >
      ...
      >
        <Lightbulb className="h-6 w-6" strokeWidth={3} />
      </span>
      <span className="min-w-0">
        ...
        <span className="mt-1 block text-xs font-bold leading-tight text-slate-600">
          Laat de mascotte helpen wanneer nodig.
        </span>
      </span>
      <span
        aria-hidden="true"
