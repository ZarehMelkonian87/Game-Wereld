 ...
 * @description Witte kaart met oog-uit icoon en toggle switch voor verminderde animaties.
 */
...
export const ToggleReducedMotion: React.FC<ToggleReducedMotionProps> = ({
  ...
  onChange,
  className = "",
  "data-testid": testId = "settings-reduced-motion-toggle",
}) => {
  return (
    <button
      type="button"
      aria-label="Rustige beweging aan of uit"
    ...
    >
      ...
      <span className="min-w-0">
        ...
        <span className="mt-1 block text-xs font-bold leading-tight text-slate-600">
          Minder beweging en minder pulse-effecten.
        </span>
      </span>
      <span
        aria-hidden="true"
