...
export const BtnActionKlaar: React.FC<BtnActionKlaarProps> = ({
  ...
  return (
    <button
      ...
      className={`px-6 py-3 bg-emerald-700 text-white font-extrabold text-lg rounded-full shadow-md border-b-4 border-emerald-900 flex items-center gap-2 hover:bg-emerald-600 active:scale-95 disabled:opacity-50 transition-all ${className}`}
      {...props}
    >
