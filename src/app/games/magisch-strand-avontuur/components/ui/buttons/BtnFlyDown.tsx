 ...
 * @description Besturingsknop omlaag in de actieve vlieg-gameplay.
 */
export interface BtnFlyDownProps {
  onClick?: () => void;
  className?: string;
  "data-testid"?: string;
}

export const BtnFlyDown: React.FC<BtnFlyDownProps> = ({
  onClick,
  className = "",
  "data-testid": testId,
}) => {
