...
export function UiBuildingBlocksPreview() {
  return (
    <div
    ...
    >
      <div className="mx-auto flex w-full max-w-sm flex-col gap-4 landscape:max-w-3xl landscape:gap-2">
        <div className="flex justify-center">
          <RibbonTitle className="landscape:min-h-10 landscape:py-1">UI bouwstenen</RibbonTitle>
        </div>

        <div className="grid gap-4 landscape:grid-cols-2 landscape:gap-2">
