...
export const SettingsToggleRow = ({
  ...
  <button
    aria-label={`${label} aan of uit`}
    aria-pressed={checked}
    className="grid min-h-14 w-full grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2.5 rounded-2xl border-2 border-white/80 bg-white/82 p-2.5 text-left shadow-[0_3px_0_rgba(15,23,42,0.12)] active:translate-y-0.5"
    data-testid={testId}
    onClick={onToggle}
    type="button"
  >
