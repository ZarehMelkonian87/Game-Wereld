  ...
  return (
    ...
    >
      ...
      <label className="mt-2 block">
        ...
        <input
          className="min-h-10 w-full rounded-2xl border-2 border-sky-200 bg-white px-3 text-sm font-black text-slate-900 outline-none focus:border-sky-500"
      ...
      <div className="mt-2 grid grid-cols-[minmax(0,1fr)_auto] gap-2">
        <button
          className="min-h-10 rounded-2xl border-2 border-sky-500 bg-sky-500 px-3 text-xs font-black text-white shadow-[0_3px_0_rgba(2,132,199,0.35)] active:translate-y-0.5"
