...
export const DropdownPrivacyFaq: React.FC<DropdownPrivacyFaqProps> = ({
  ...
  answer = "De microfoon wordt uitsluitend in realtime gebruikt om gesproken circuswoorden te herkennen voor het vliegen en plaatsen van objecten. Er worden geen audio-opnames opgeslagen op een server.",
  className = "",
}) => {
