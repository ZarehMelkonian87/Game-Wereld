...
export const FooterQuizProgress: React.FC<FooterQuizProgressProps> = ({
  ...
  return (
    <div
      className={`p-3 bg-amber-100/90 rounded-2xl border border-amber-300 shadow flex items-center justify-between gap-4 max-w-md w-full mx-auto ${className}`}
    >
      <span className="font-extrabold text-amber-950 text-xs whitespace-nowrap">
        Voortgang {progress}/{maxProgress}
      </span>
