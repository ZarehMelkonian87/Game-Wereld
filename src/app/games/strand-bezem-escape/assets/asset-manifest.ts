...
export const sideScrollerObstacleAssets: BezemEscapeImageAsset[] = [
  readyAsset(
    ...
    "Wolk Obstakel",
    "obstacle",
    "objects/side-scroller/cloud-obstacle.png",
  ),
  readyAsset(
    "seagull-obstacle",
    "Meeuw Obstakel",
    "obstacle",
    "objects/side-scroller/seagull-obstacle.png",
  ),
  readyAsset(
    "shark-obstacle",
    "Haai Obstakel",
    "obstacle",
    "objects/side-scroller/shark-obstacle.png",
  ),
  readyAsset(
    "sea-lion-obstacle",
    "Zeeleeuw Obstakel",
    "obstacle",
    "objects/side-scroller/sea-lion-obstacle.png",
  ),
];
