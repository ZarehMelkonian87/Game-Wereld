...
| `DT-02` | **Spraak — Zeg & Vlieg** | Start Zeg & Vlieg, benoem hardop de objecten die voorbij vliegen | Object wordt verzameld bij correct benoemen; **blijft werken na meerdere objecten** (niet stoppen na 2-3). Let op: ontwijk obstakels met de duim-rail — 3 botsingen = ronde-einde | `T-18`, `T-48` | 🟦 Kernfix (`T-48`) — hertesten op apparaat |
