...
| **T-37** | P2 | 🔍 | **Playwright-e2e bijwerken voor `T-35`/`T-03`** — tests 3.5, 3.6 en de a11y-kernopdracht + delen van `generate-visual-report` gebruiken nog de verwijderde `scene-builder-confirm-button` ("Klaar"→"Volgende"). Herschrijven naar de auto-bevestigings-flow (plaatsing → automatisch bevestigd + auto-doorgaan) en het ronde-eindscherm. Ontdekt bij het draaien van e2e voor `T-31` | Bij T-31 e2e-run | ⬜ |
