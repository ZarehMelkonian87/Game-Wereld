...
| **T-04** | P3 | 🎨🔧 | Modus **`zeg-en-bouw`** — concept vastgesteld → [Concept-Zeg-en-Bouw](Concept-Zeg-en-Bouw.md). **In uitvoering** (bouw als laatste, ná de 3 bestaande modi). Subtaken: `T-04a` concept/docs ✅ · **`T-04b` compound-parser ✅** (`parseCompoundPlacements`: meerdere plaatsingen uit één zin, 7 unit-tests) · `T-04c` scherm `SCR_MSA_ZEG_BOUW` + bouwkaarten (variant A) ⬜ · `T-04d` ronde-einde + Strandschat ⬜ · `T-04e` variant B Vrij Bouwen (optioneel) ⬜ | GAP-04 / 4.6 | 🟦 |
