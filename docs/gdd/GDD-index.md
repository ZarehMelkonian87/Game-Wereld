...
| **T-34** | **P1** | 🔧 | **Mic-robuustheid bij onverstaanbare/andere-taal invoer** — vriendelijke feedback + mic **altijd herstartbaar**. Deels opgelost via `T-35` ("Opnieuw zeggen" herstart de mic); resterend: nette feedback bij écht onverstaanbare/geen-match invoer | Testfeedback 2026-09-14 | ⬜ |
