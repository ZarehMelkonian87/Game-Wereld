...
| `TC_SCENE_02` | `FEAT_SCENE_KB_*`, `FEAT_SCENE_PARSE`           | Typen + bevestigen plaatst het object; overtyp-laag kleurt per letter, fout + Backspace herstelt, geen "Bijvoorbeeld"-regel (`T-54`)             | 🤖   | spec 3.2                                                                  |    ✅     |
