# ✅ Test-matrix — Wilde Dierentuin-Avontuur

> Welke test bewijst welke functie. Eén op één overgenomen van het [strandspel](../magisch-strand-avontuur/Test-matrix.md): dezelfde testcases, dezelfde bewijslast, dierentuin-content.
...
| `TC_SCENE_05`  | `FEAT_SCENE_PARSE`         | Parser levert object, relatie, zone en betrouwbaarheid (dierentuin-aliassen) | 🧪   |   🔵   |
