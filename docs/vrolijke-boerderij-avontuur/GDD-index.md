# 🚜 GDD — Vrolijke Boerderij-Avontuur

> **Algemeen game design document.** Vrolijke Boerderij-Avontuur is een woordenschatgame met **exact dezelfde gameplay als [Magisch Strand-Avontuur](../magisch-strand-avontuur/GDD-index.md)**; alleen de wereld, de woorden en de plaatjes verschillen.
...
**Wat verschilt:** de wereld (een boerderij met een wei, een vijver, een schuur en een molen.), de 14 woorden, de plekken en alle plaatjes, video's en geluiden.

> Voor de werking van een onderdeel geldt de [strand-GDD](../magisch-strand-avontuur/GDD-index.md) als bron; dit document beschrijft alleen wat boerderij-eigen is.

## 2. De wereld

Een boerderij met een wei, een vijver, een schuur en een molen. Het kind zet spullen en dieren neer op het erf met de wei, de vijver en de schuur.

| Plek          | Wat het kind ziet                  |
| :------------ | :--------------------------------- |
| `lucht`       | De lucht boven de boerderij.       |
| `wei`         | Het grasveld waar de dieren lopen. |
| `links-wei`   | Linkerkant van de wei.             |
| `boven-wei`   | Luchtgebied boven de wei.          |
| `ver-weg-wei` | Een plek ver weg boven de wei.     |
| `vijver`      | De vijver waar de eenden zwemmen.  |
| `erf`         | Het erf op de voorgrond.           |
| `midden-erf`  | Midden van het erf.                |
| `rechts-erf`  | Rechterkant van het erf.           |
...
| Zones                 | 9 + dynamisch | boerderij-eigen                        |
