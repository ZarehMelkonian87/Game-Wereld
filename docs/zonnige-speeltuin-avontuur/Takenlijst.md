...
| lp-003 | `lp-003-opdracht-leg-het-springtouw-op-het-pad.mp4`                   | Leg het springtouw op het pad.                   | De wereld met het springtouw in de objectbalk; een hand pakt het en zet het op de juiste plek. |
| lp-003 | `lp-003-hint-01-zoek-het-springtouw.mp4`                              | Zoek het springtouw.                             | De objectbalk onderin; het springtouw licht op en wipt even.                                   |
| lp-003 | `lp-003-hint-02-kijk-naar-springtouw.mp4`                             | Kijk naar het plaatje dat oplicht: springtouw.   | Alleen het springtouw blijft helder, de rest vervaagt.                                         |
| lp-003 | `lp-003-feedback-het-springtouw-ligt-op-het-pad.mp4`                  | Het springtouw ligt op het pad.                  | Het voorwerp staat op zijn plek en beweegt kort vrolijk.                                       |
...
| lp-009 | `lp-009-opdracht-zet-de-bloem-naast-de-schep.mp4`                     | Zet de bloem naast de schep.                     | De wereld met de bloem in de objectbalk; een hand pakt het en zet het op de juiste plek.       |
| lp-009 | `lp-009-hint-01-zoek-de-bloem.mp4`                                    | Zoek de bloem.                                   | De objectbalk onderin; de bloem licht op en wipt even.                                         |
| lp-009 | `lp-009-hint-02-kijk-naar-bloem.mp4`                                  | Kijk naar het plaatje dat oplicht: bloem.        | Alleen de bloem blijft helder, de rest vervaagt.                                               |
| lp-009 | `lp-009-feedback-de-bloem-staat-naast-de-schep.mp4`                   | De bloem staat naast de schep.                   | Het voorwerp staat op zijn plek en beweegt kort vrolijk.                                       |
...
| lp-016 | `lp-016-opdracht-leg-het-springtouw-tussen-de-bloem-en-de-schep.mp4`  | Leg het springtouw tussen de bloem en de schep.  | De wereld met het springtouw in de objectbalk; een hand pakt het en zet het op de juiste plek. |
| lp-016 | `lp-016-hint-01-zoek-het-springtouw.mp4`                              | Zoek het springtouw.                             | De objectbalk onderin; het springtouw licht op en wipt even.                                   |
| lp-016 | `lp-016-hint-02-kijk-naar-springtouw.mp4`                             | Kijk naar het plaatje dat oplicht: springtouw.   | Alleen het springtouw blijft helder, de rest vervaagt.                                         |
| lp-016 | `lp-016-feedback-het-springtouw-ligt-tussen-de-bloem-en-de-schep.mp4` | Het springtouw ligt tussen de bloem en de schep. | Het voorwerp staat op zijn plek en beweegt kort vrolijk.                                       |

### 3.2 Video's bij de quizvragen — 14 clips

| ID     | Bestandsnaam                                 | Gesproken tekst         | Wat je in beeld ziet                                                      |
| :----- | :------------------------------------------- | :---------------------- | :------------------------------------------------------------------------ |
| cw-001 | `cw-001-opdracht-waar-is-het-springtouw.mp4` | Waar is het springtouw? | De keuzekaarten in beeld; de mascotte kijkt vragend, geen kaart licht op. |
...
| cw-007 | `cw-007-opdracht-waar-is-de-bloem.mp4`       | Waar is de bloem?       | De keuzekaarten in beeld; de mascotte kijkt vragend, geen kaart licht op. |
...
| **A-05** |  🎨  | **Logo en wereldicoon** — het icoon bestaat al (`world-speeltuin.webp`); een startlogo moet nog        |   ⬜   |
...
| `jumprope-sticker.webp`      | springtouw | Een springtouw om mee te springen.  |
...
| `flower-sticker.webp`        | bloem      | Een vrolijke bloem in het gras.     |
