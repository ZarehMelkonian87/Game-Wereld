...
```mermaid
graph TD
    subgraph Game-Wereld Groep 3
        Z1["1. Taal & Lezen Zone"]
        Z2["2. Rekenen & Getallen Zone"]
        Z3["3. Speciale Woordenschat Zone <br/>(Woordenschat Bezem Escape)"]
        Z4["4. Wereldoriëntatie Zone"]
        Z5["5. Social-Emotional & Verkeer Zone"]
    end
    
    style Z3 fill:#fbbf24,stroke:#d97706,stroke-width:3px;
```
...
| **Spelling** | Foutloos spellen van klankzuivere woorden (MKM zoals *kat*, *bos*). | Spellen van woorden met medeklinker-combinaties (*strand*, *feest*) en verkleinwoorden. |
